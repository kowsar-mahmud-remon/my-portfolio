...
const NavBar = () => {
  const menuItems = <React.Fragment>
    ...
    <li className='font-medium'><a href="#about">About Me</a></li>
    <li className='font-medium'><a href="#skills">My Skills</a></li>
    <li className='font-medium'><a href="#projects">My Projects</a></li>
